...
export default function Home() {
  ...
  const [openPanel, setOpenPanel] = useState<"workout" | "log" | "youtube" | null>(null);
  ...
  const togglePanel = (panel: "workout" | "log" | "youtube", open: boolean) => setOpenPanel((current) => open ? panel : current === panel ? null : current);
