...
type Video = { url: string; label: string; videoId?: string; thumbnailData?: string; category?: VideoCategory; guideStatus?: "analyzing" | "ready" | "failed"; guideError?: string; workoutGuide?: WorkoutGuide };
...
function makeBackupFile(sessions: Session[], libraryExercises: LibraryExercise[], futureVideos: Video[], insightReports: TrainingInsightReport[], goals: FitnessGoals, scheduleKeys: string[], customWorkouts: CustomWorkout[]) {
  const payload = { schemaVersion: 1, exportedAt: new Date().toISOString(), sessions, libraryExercises, futureVideos, insightReports, goals, scheduleKeys, customWorkouts, settings: { weekStartsOn: "monday", adherenceThreshold: 5 } };
...
function VideoCard({ video, onDelete, onRetry, onRefresh, onClearGuide, onAddToday, categoryLabel, onCategoryChange }: { video: Video; onDelete?: () => void; onRetry?: () => void; onRefresh?: () => void; onClearGuide?: () => void; onAddToday?: () => void; categoryLabel?: string; onCategoryChange?: (category: VideoCategory | "") => void }) {
...
function MoreView({ libraryExercises, setLibraryExercises, futureVideos, setFutureVideos, insightReports, setInsightReports, fitnessGoals, setFitnessGoals, scheduleKeys, setScheduleKeys, customWorkouts, setCustomWorkouts, sessions, setHistory, aiAccessCode, onSaveAiAccessCode, onDeleteVideo, onClearGuide, onAddToToday }: { libraryExercises: LibraryExercise[]; setLibraryExercises: React.Dispatch<React.SetStateAction<LibraryExercise[]>>; futureVideos: Video[]; setFutureVideos: React.Dispatch<React.SetStateAction<Video[]>>; insightReports: TrainingInsightReport[]; setInsightReports: React.Dispatch<React.SetStateAction<TrainingInsightReport[]>>; fitnessGoals: FitnessGoals; setFitnessGoals: React.Dispatch<React.SetStateAction<FitnessGoals>>; scheduleKeys: string[]; setScheduleKeys: React.Dispatch<React.SetStateAction<string[]>>; customWorkouts: CustomWorkout[]; setCustomWorkouts: React.Dispatch<React.SetStateAction<CustomWorkout[]>>; sessions: Session[]; setHistory: React.Dispatch<React.SetStateAction<Session[]>>; aiAccessCode: string; onSaveAiAccessCode: (value: string) => void; onDeleteVideo: (sessionId: string, videoIndex: number) => void; onClearGuide: (sessionId: string, videoIndex: number) => void; onAddToToday: (video: Video) => Promise<string> }) {
  ...
  async function saveFutureVideo() {
    ...
    const video: Video = { url, label, videoId, thumbnailData, category: futureCategory || undefined, guideStatus: "analyzing" };
    setFutureVideos((items) => [video, ...items]); setFutureUrl(""); setFutureCategory(""); setSavingFutureVideo(false); setFutureNotice("Saved for later. Building its workout guide…");
    try {
