...
const APP_VERSION = "2026.09.22 1935";
const RELEASE_CHANGES = [
  "The What’s new label now stands out with a warm accent color.",
  "Release updates are organized into cleaner, easy-to-scan bullets.",
];
