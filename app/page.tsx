...
const APP_VERSION = "2026.09.22 1854";
const RELEASE_CHANGES = [
  "The release stamp now opens a quick What’s new summary.",
  "Release labels now show the publication date and time.",
];
