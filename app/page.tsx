...
export default function Home() {
  ...
  const toggleInjury = () => { if (injuryReported) { update({ injury: { reported: false, impact: "", bodyArea: "", note: "" } }); setShowInjury(false); } else { update({ injury: { reported: true, impact: "", bodyArea: "", note: "" } }); setShowInjury(true); } };
